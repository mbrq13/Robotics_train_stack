...
def main() -> None:
    ...
    parser.add_argument("--station-config", default="configs/robots/piper_bimanual.yaml")
    parser.add_argument("--worker-config", default="configs/deploy/policy_worker.yaml")
